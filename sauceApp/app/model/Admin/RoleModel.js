Ext.define('SauceApp.model.Admin.RoleModel', {
	extend : 'Ext.data.Model',
	fields : ['roleName', 'roleBizRule', 'roleData', 'roleDescription'],		
	idProperty :'roleName',
	proxy : {
		type : 'ajax',
		api : {
			read : 'index.php/privileges/RoleList',
			update : 'index.php/privileges/RoleUpdate',
			//create : 'index.php/privileges/RoleCreate',
			destroy : 'index.php/privileges/RoleDelete'
		},
		reader : {
			type : 'json',
			root : 'data',
