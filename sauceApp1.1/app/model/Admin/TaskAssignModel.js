Ext.define('SauceApp.model.Admin.TaskAssignModel', {
	extend : 'Ext.data.Model',
	fields : [{name:'assignName', type : 'string'}, 
			'assignType', 'assignDescription', 'assignData','taskType','taskName', 'taskDescription'],				
	idProperty :['AssignName', 'taskName'],
	proxy : {
		type : 'ajax',
		api : {
			read : 'index.php/privileges/AssignTaskList',
			update : 'index.php/privileges/AssignUpdate',
			//create : 'index.php/privileges/AssignCreate',
			destroy : 'index.php/privileges/AssignDelete'
		},
		reader : {
			type : 'json',
			root : 'data',
