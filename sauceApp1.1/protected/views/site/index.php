...
<body class="x-border-layout-ct">
    ...
    <div id="viewport">
            <link rel="stylesheet" type="text/css" href="../ext-4.2.0-gpl/resources/ext-theme-neptune/ext-theme-neptune-all.css" />
    		<link rel="stylesheet" type="text/css" href="app/css/app.css">

            <script type="text/javascript">document.getElementById('loading-msg').innerHTML = 'Carregando API...';</script>
            <script type="text/javascript" src="../ext-4.2.0-gpl/ext-all-debug.js"></script>
            <script type="text/javascript" src="../ext-4.2.0-gpl/ext-theme-neptune.js"></script>
            <script type="text/javascript" src="../ext-4.2.0-gpl/locale/ext-lang-zh_CN.js"></script>
